...
const BottomNav: Component = () => {
  ...
  return (
    <nav class="fixed bottom-0 left-0 right-0 bg-surface-light border-t border-surface-lighter safe-bottom">
      <div class="max-w-lg mx-auto flex justify-around py-1">
